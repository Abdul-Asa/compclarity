...
export const metadata: Metadata = {
  title: "CompClarity - Privacy Policy",
  // description: "CompClarity's mission is dedicated to demystifying compensation packages across Europe, starting with the tech industry, by ensuring that you have all the information required to understand your worth and make informed decisions.",
};

export default function Privacy() {
  return (
    <div className="mx-5 mt-4 flex flex-col items-center justify-center gap-7 text-lg sm:mx-auto sm:w-3/5">
      <h1 className="font-bold uppercase underline">Privacy Policy of CompClarity</h1>
      <small className="italic">Last updated: 24/07/2024</small>
      <div className="font-open flex flex-col items-start justify-start gap-3 text-sm leading-loose">
        <section className="flex flex-col gap-2">
          <p>CompClarity operates the https://compclarity.com website, which provides the SERVICE.</p>

          <p>
            This page is used to inform website visitors regarding our policies with the collection, use, and disclosure
            of Personal Information if anyone decided to use our Service, the compclarity.com website.
          </p>
          ...
          <p>
            ...
            accessible at https://compclarity.com, unless otherwise defined in this Privacy Policy.
          </p>
        </section>
        <section>
          <h2 className="font-sm font-bold underline">Information Collection and Use</h2>
          <p>
            If you have a reason to believe a data entry can be linked to you, please email contact@compclarity.com and
            we will remove it within 5 business days. If you wish to delete your account and all its associated data,
            please email contact@compclarity.com and we will process it within 5 business days. Salary submissions are
            anonymous and NOT linked to user accounts.
          </p>
        </section>
        <section>
          <h2 className="font-sm font-bold underline">Log Data</h2>
          <p>
            ...
            Protocol (&quot;IP&quot;) address, browser version, pages of our Service that you visit, the time and date
            of your visit, the time spent on those pages, and other statistics.
          </p>
        </section>
        <section>
          <h2 className="font-sm font-bold underline">Cookies</h2>
          <p>
            ...
            website uses these &quot;cookies&quot; to collection information and to improve our Service. You have the
            option to either accept or refuse these cookies, and know when a cookie is being sent to your computer. If
            you choose to refuse our cookies, you may not be able to use some portions of our Service.
          </p>
        </section>
        <section>
          <h2 className="font-sm font-bold underline">Service Providers</h2>
          <p>
        ...
        <section>
          <h2 className="font-sm font-bold underline">Security</h2>
          <p>
        ...
        <section>
          <h2 className="font-sm font-bold underline">Links to Other Sites</h2>
          <p>
        ...
        <section>
          <h2 className="font-sm font-bold underline">Children&apos;s Privacy</h2>
          <p>
        ...
        <section>
          <h2 className="font-sm font-bold underline">Changes to This Privacy Policy</h2>
          <p>
        ...
        <section>
          <h2 className="font-sm font-bold underline">Contact Us</h2>
