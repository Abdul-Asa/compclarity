...
export const metadata: Metadata = {
  ...
  description: "Sign in or register for an account to start using our job application tracker",
};
  ...
  return (
    <div className="my-8 flex flex-col items-center">
      <div className="flex flex-col gap-2 py-4 text-center">
        ...
        <p className="font-open text-sm md:text-lg">Apply effortlessly and track your progress</p>
      </div>
