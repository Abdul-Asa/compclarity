...
export default function RoleDropdownMenu({
  ...
  return (
    <Menu as="div" className="relative z-20">
      ...
      >
        <Menu.Items className="absolute left-1/2 mt-2 min-w-max origin-top -translate-x-1/2 transform divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-none">
            ...
            <Menu.Item>
              {({ active }) => (
                <Link
                  ...
                  href={
                    isForCompany
                      ? `/company/${companyParams}/salaries`
                      : "/tech"
                  }
                >
            ...
            <Menu.Item>
              {({ active }) => (
                <Link
                  ...
                  href={
                    isForCompany
                      ? `/company/${companyParams}/salaries/finance`
                      : "/finance"
                  }
                >
