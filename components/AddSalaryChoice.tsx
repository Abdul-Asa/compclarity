...
export const AddSalaryChoice = ({}: AddSalaryChoiceProps) => {
  ...
  return isAddManual === false ? (
    <div className="flex w-full items-center justify-center">
      <div className="flex w-fit flex-col items-center rounded-lg bg-white p-12">
        <span className="text-center text-3xl font-bold">
          Share Your Salary
        </span>
        <span className="mb-6 mt-2 text-center text-gray-500">
        ...
        <div className="flex w-full flex-col justify-center space-x-0 space-y-4 md:flex-row md:space-x-16 md:space-y-0">
          <div className="flex flex-1 flex-col rounded-md bg-gray-100 p-6 text-left">
            ...
            <div className="flex justify-center">
              <button
                ...
                className="mt-4 rounded bg-emerald-700 px-6 py-2 font-bold text-white hover:bg-gray-800"
              >
                Start
              </button>
            </div>
