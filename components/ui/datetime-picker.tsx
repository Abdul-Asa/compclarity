    ...
    <Popover open={open} onOpenChange={setOpen} modal={modal}>
      ...
      <PopoverContent className="w-auto p-2">
        <div className="flex items-center justify-between">
          <div className="text-md font-bold ms-2 flex items-center gap-2 cursor-pointer">
            <div>
              <span
              ...
              <span
                className="ms-1 hover:underline transition-all duration-100"
        ...
        <div className="relative overflow-hidden">
          <DayPicker
            ...
            classNames={{
              ...
              today: "bg-accent text-accent-foreground border-b border-primary",
              outside:
