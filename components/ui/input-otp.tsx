  ...
  ({ char, hasFakeCaret, isActive, className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          "relative flex h-16 w-16 items-center justify-center border-y border-r border-border-dark text-2xl transition-all first:rounded-l-md first:border-l last:rounded-r-md",
