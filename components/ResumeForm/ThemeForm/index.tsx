...
import { changeSettings, DEFAULT_THEME_COLOR, selectSettings, type GeneralSetting } from "@/lib/store/settings";
    ...
    <BaseForm>
      <div className="flex flex-col gap-6">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-semibold tracking-wide text-gray-900 ">Resume Setting</h1>
        </div>
        <div>
          <InlineInput
            label="Theme Color"
