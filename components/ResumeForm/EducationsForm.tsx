...
import { changeEducations, selectEducations } from "@/lib/store/configs";
import type { ResumeEducation } from "@/lib/store/configs";
import { changeShowBulletPoints, selectShowBulletPoints } from "@/lib/store/settings";
  ...
  return (
    <Form form={form} addButtonText="Add School">
      {educations.map(({ school, degree, gpa, date, descriptions }, idx) => {
        const handleEducationChange = (...[field, value]: CreateHandleChangeArgsWithDescriptions<ResumeEducation>) => {
