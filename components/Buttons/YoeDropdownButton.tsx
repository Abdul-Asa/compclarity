...
export default function YoeDropdownButton() {
  ...
  return (
    <Listbox as="div" className="relative z-10 mt-1">
      <Listbox.Button className="relative w-full cursor-default rounded-md bg-white dark:bg-black border border-border py-2 pl-3 pr-10 text-left shadow-md focus:outline-none focus-visible:border-brand focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm">
            ...
            <div className="flex flex-col space-y-2">
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full rounded-sm p-2 border-border shadow-sm focus:border-brand focus:ring-brand sm:text-sm"
                  placeholder="Years"
                />
              </div>
              <div>
              ...
              <button
                ...
                className="mt-4 inline-flex justify-center rounded-md border border-transparent bg-brand py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-brand-light"
              >
                Apply
              </button>
            </div>
