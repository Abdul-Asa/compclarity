    ...
    >
      <div className="relative z-10 mt-1">
        ...
        <Transition as={Fragment} leave="transition ease-in duration-100" leaveFrom="opacity-100" leaveTo="opacity-0">
          <Listbox.Options className="absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white dark:bg-gray-900 dark:border-gray-700 dark:border py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
