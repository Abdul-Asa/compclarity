    ...
    <>
      <div className="flex-col items-center">
        <Link href={`/company/${companyDetails.name.replace(/\s+/g, "-").toLowerCase()}/salaries`}>
          <button
            className={`bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-400 text-lg md:text-base px-6 py-2 rounded-l-lg w-24 ${
        ...
        <Link href={`/company/${companyDetails.name.replace(/\s+/g, "-").toLowerCase()}/jobs`}>
          <button
            className={`bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-400 text-lg md:text-base px-6 py-2 rounded-r-lg w-24 ${
              isJobs ? "font-bold" : ""
            }`}
          >
            Jobs
